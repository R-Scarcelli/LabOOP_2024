...
public class SimpleBankAccount implements BankAccount {
    ...
    private boolean checkId(final int id) {
        return this.id == id;
    }

    private int incrementTransaction() {
        return this.transactions++;
    }
    ...
    public void chargeManagementFees(final int id) {
         ...
         */
        // NON HO CAPITO COSA VOGLAI DIRE
    }

    @Override
    public String toString() {
        return "SimpleBankAccount [id=" + id + ", balance=" + balance + ", transactions=" + transactions + "]\n";
    }
}
